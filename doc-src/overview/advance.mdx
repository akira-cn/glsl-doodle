...
<CodePen codeId="YogyOQ" height="370"></CodePen>
...
<CodePen codeId="pXYjBX" height="370"></CodePen>

## 使用自定义 uniform

在 shader 中声明的 uniform 变量，在 glsl-doodle 中可以通过 `doodle.uniforms.变量名` 的方式直接赋值：

<CodePen codeId="JQzXGa" height="370"></CodePen>
...
<CodePen codeId="dBrMjx" height="370"></CodePen>

其他内建 uniform 详见文档[内建属性](/buildins)。

## 使用网格数据

我们可以使用 setMeshData 给 doodle 传入数据，glsl-doodle 会使用当前的 program 完成渲染。

<CodePen codeId="MMxyRB" height="370"></CodePen>
